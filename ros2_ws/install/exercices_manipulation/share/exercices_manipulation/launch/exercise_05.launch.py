...
"""
Launch file for Exercise 5: Cartesian Circle Motion with Franka FR3 Robot
This launch file sets up MoveIt with fake hardware for the Franka robot
and runs exercise 5 using the MoveItCpp API.
"""
...
def generate_launch_description():
    ...
    # Exercise 5 node with all required MoveItCpp parameters
    exercise_05_node = Node(
        package='exercices_manipulation',
        executable='exercise_05_cartesian_circle',
        name='exercise_05_cartesian_circle',
        output='screen',
        parameters=[
            robot_description,
