...
"""
Launch file for Exercise 7: Create Graspable Object with Franka FR3 Robot
This launch file sets up MoveIt with fake hardware for the Franka robot
and runs exercise 7 using the MoveItCpp API.
"""
...
def generate_launch_description():
    ...
    # Exercise 7 node with all required MoveItCpp parameters
    exercise_07_node = Node(
        package='exercices_manipulation',
        executable='exercise_07_create_graspable_object',
        name='exercise_07_create_graspable_object',
        output='screen',
        parameters=[
            robot_description,
