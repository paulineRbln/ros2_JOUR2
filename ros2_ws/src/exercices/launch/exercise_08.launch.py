...
"""
Launch file for Exercise 8: Pick and Place with Franka FR3 Robot
This launch file sets up MoveIt with fake hardware for the Franka robot
and runs exercise 8 using the MoveItCpp API.
"""
...
def generate_launch_description():
    ...
    # Exercise 8 node with all required MoveItCpp parameters
    exercise_08_node = Node(
        package='exercices_manipulation',
        executable='exercise_08_pick_and_place',
        name='exercise_08_pick_and_place',
        output='screen',
        parameters=[
            robot_description,
