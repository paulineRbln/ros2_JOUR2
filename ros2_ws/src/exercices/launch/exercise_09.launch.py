...
"""
Launch file for Exercise 9: Constrained Motion Planning with Franka FR3 Robot
This launch file sets up MoveIt with fake hardware for the Franka robot
and runs exercise 9 using the MoveItCpp API.
"""
...
def generate_launch_description():
    ...
    # Exercise 9 node with all required MoveItCpp parameters
    exercise_09_node = Node(
        package='exercices_manipulation',
        executable='exercise_09_constrained_motion',
        name='exercise_09_constrained_motion',
        output='screen',
        parameters=[
            robot_description,
