...
"""
Launch file for Exercise 3: Joint Space Motion with Franka FR3 Robot
This launch file sets up MoveIt with fake hardware for the Franka robot
and runs exercise 3 using the MoveItCpp API.
"""
...
def generate_launch_description():
    ...
    # Exercise 3 node with all required MoveItCpp parameters
    exercise_03_node = Node(
        package='exercices_manipulation',
        executable='exercise_03_joint_space_motion',
        name='exercise_03_joint_space_motion',
        output='screen',
        parameters=[
            robot_description,
