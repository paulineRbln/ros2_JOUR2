...
"""
Launch file for Exercise 6: Add Obstacles with Franka FR3 Robot
This launch file sets up MoveIt with fake hardware for the Franka robot
and runs exercise 6 using the MoveItCpp API.
"""
...
def generate_launch_description():
    ...
    # Exercise 6 node with all required MoveItCpp parameters
    exercise_06_node = Node(
        package='exercices_manipulation',
        executable='exercise_06_add_obstacles',
        name='exercise_06_add_obstacles',
        output='screen',
        parameters=[
            robot_description,
