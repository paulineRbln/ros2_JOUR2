/**
 * Exercise 7: Create a graspable object
 * Add a cylinder object that will serve as a graspable object for pick and place
...
static const std::string LOGNAME = "exercise_07_create_graspable_object";
static const std::vector<std::string> CONTROLLERS(1, "panda_arm_controller");

// Helper: Add a graspable cylinder object to the planning scene
void addGraspableCylinder(
...
int main(int argc, char * argv[])
{
    ...
    RCLCPP_INFO(logger, "Starting Exercise 7: Create Graspable Object with Franka FR3...");
    ...
    // Prompt user before adding graspable object
    visual_tools.prompt("Press 'Next' in RViz to ADD graspable object to the scene");
    RCLCPP_INFO(logger, "Adding graspable cylinder object to the scene...");
    
    // TODO : Define cylinder shape and pose for the graspable object and add it to the planning scene with addGraspableCylinder

    addGraspableCylinder(planning_scene_interface, "fr3_link0", "graspable_cylinder", cylinder, cylinder_pose);

    // Prompt user to plan
    visual_tools.prompt("Press 'Next' in RViz to PLAN motion towards object");
    RCLCPP_INFO(logger, "Planning motion to approach graspable object...");

    // TODO : Define target pose above the cylinder object

    planAndExecute(planning_components, visual_tools, target_pose, joint_model_group_ptr, moveit_cpp_ptr, "Approach graspable object");

    RCLCPP_INFO(logger, "\n=== Exercise 7 completed! ===");
    RCLCPP_INFO(logger, "Graspable cylinder object is visible in the scene.");
